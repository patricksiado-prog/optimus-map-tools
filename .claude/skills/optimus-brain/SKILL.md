---
name: optimus-brain
description: The Optimus operating brain — who Patrick Siado's AT&T fiber dealership is, the green/gold/grey dot legend and what each is worth, the master sheet and GoHighLevel IDs, which sheet tabs the hunter owns, and the texting, DealMachine and data-integrity facts that were learned the expensive way. Load this whenever the work touches Optimus, AT&T fiber leads, the fiber map, gold or green dots, the ATT FIBER LEADS sheet, GoHighLevel outreach, DealMachine skip tracing, or the hunter — and load it before texting, quoting a price, or spending DealMachine credits, because those are where the costly mistakes live.
---
