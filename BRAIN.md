...
- Frontline Direct (TXw28sw0Z2rl6tcCDhJY) — "claude-writes" (ALL scopes incl WRITE, 2026-06-06): pit-9b15a452-5250-4c33-bacc-0bd749046f1d  <-- put this in Railway GHL_API_KEY for ghl-full write. NOTE 2026-06-06: the value ACTUALLY live in the ghl-full server (loving-heart project) GHL_API_KEY is pit-4657ee4f-b31a-4928-a2a9-552402946c46 (read off Railway). If ghl-full is 403'ing, this token is the suspect — rotate-and-copy a fresh Frontline write token in GHL, paste into loving-heart GHL_API_KEY, redeploy, re-approve connector.
